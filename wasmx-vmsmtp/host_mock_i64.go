...
func BuildWasmxSmtpVMMock_i64(ctx_ *vmtypes.Context, rnh memc.RuntimeHandler) (interface{}, error) {
	...
	vm := rnh.GetVm()
	fndefs := []memc.IFn{
		vm.BuildFn("ClientConnect", ClientConnectMock, []interface{}{vm.ValType_I64()}, []interface{}{vm.ValType_I64()}, 0),
		...
		vm.BuildFn("Hello", HelloMock, []interface{}{vm.ValType_I64()}, []interface{}{vm.ValType_I64()}, 0),
