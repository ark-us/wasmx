...
//
//go:wasmimport postgresql Connect
func Connect_(reqPtr int64) int64

//go:wasmimport postgresql Close
func Close_(reqPtr int64) int64

//go:wasmimport postgresql Ping
func Ping_(reqPtr int64) int64

//go:wasmimport postgresql Execute
func Execute_(reqPtr int64) int64

//go:wasmimport postgresql BatchAtomic
func BatchAtomic_(reqPtr int64) int64

//go:wasmimport postgresql Query
func Query_(reqPtr int64) int64

//go:wasmimport postgresql CreateDatabase
func CreateDatabase_(reqPtr int64) int64
...
func CreateDatabase(req *SqlCreateDatabase) SqlCreateDatabaseResponse {
	bz, err := json.Marshal(req)
	if err != nil {
		panic(err)
	}
	ptr := CreateDatabase_(utils.BytesToPackedPtr(bz))
	resp := SqlCreateDatabaseResponse{}
	err = json.Unmarshal(utils.PackedPtrToBytes(ptr), &resp)
	if err != nil {
		panic(err)
	}
