module github.com/loredanacirstea/wasmx-gov-group-continuous
...
require (
	...
	github.com/loredanacirstea/wasmx-gov-group v0.0.0
)
...
replace github.com/loredanacirstea/wasmx-gov-group v0.0.0 => ../wasmx-gov-group
