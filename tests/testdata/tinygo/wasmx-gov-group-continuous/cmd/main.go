...
import (
	...
	gov "github.com/loredanacirstea/wasmx-gov-group-continuous/gov"
	gov1 "github.com/loredanacirstea/wasmx-gov-group/gov"
)
...
//go:wasm-module wasmx-gov-group-continuous
//export instantiate
func Instantiate() {
