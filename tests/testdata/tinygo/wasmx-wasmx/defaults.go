...
var (
	...
	sc_ava_snowman         = wasmx.SystemContract{Address: ADDR_CONSENSUS_AVA_SNOWMAN, Label: CONSENSUS_AVA_SNOWMAN, StorageType: wasmx.StorageSingleConsensus, InitMessage: avaInitMsg, Pinned: false, MeteringOff: false, Native: false, Role: &wasmx.SystemContractRole{Role: wasmx.ROLE_CONSENSUS, Label: CONSENSUS_AVA_SNOWMAN, Primary: false}, Deps: []string{INTERPRETER_FSM, BuildDep(ADDR_CONSENSUS_AVA_SNOWMAN_LIBRARY, wasmx.ROLE_LIBRARY)}}
