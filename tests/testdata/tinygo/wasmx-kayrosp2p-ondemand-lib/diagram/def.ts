...
export const machine = createMachine({
  ...
  states: {
        ...
        started: {
          ...
          states: {
            ...
            Validator: {
              ...
              on: {
                stop: {
                  target: "#Kayros-P2P-OnDemand-1.stopped",
                },
                receiveUpdateNodeResponse: {
                  actions: {
                    type: "receiveUpdateNodeResponse",
              ...
              states: {
                ...
                propose: {
                  after: {
                    timeoutCommit: {
                      target:
                        "#Kayros-P2P-OnDemand-1.initialized.started.waiting",
                    },
                  },
                  entry: [
                    {
            ...
            waiting: {
              ...
              after: {
                batchTimeout: {
                  target:
                    "#Kayros-P2P-OnDemand-1.initialized.started.Validator.active",
                  guard: {
    ...
    stopped: {
      on: {
        restart: {
          target: "#Kayros-P2P-OnDemand-1.initialized.unstarted",
        },
      },
    },
  },
