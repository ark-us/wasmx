module github.com/loredanacirstea/wasmx-kayrosp2p-ondemand-lib
...
require github.com/loredanacirstea/wasmx-raftp2p-lib v0.0.0

require github.com/loredanacirstea/wasmx-kayrosp2p-lib v0.0.0
