...
type CodeMetadataPB struct {
	...
	JsonSchema []byte        `protobuf:"bytes,7,opt,name=json_schema,json=jsonSchema,proto3" json:"json_schema,omitempty"`
...
func (m *CodeMetadataPB) GetJsonSchema() []byte {
	if m != nil {
		return m.JsonSchema
	}
	return nil
...
type CodeInfoPB struct {
	...
	SourceVerified                bool   `protobuf:"varint,11,opt,name=source_verified,json=sourceVerified,proto3" json:"source_verified,omitempty"`
}
...
func (m *CodeInfoPB) GetSource() []byte {
	if m != nil {
		return m.Source
	}
	return nil
...
func (m *CodeInfoPB) GetSourceVerified() bool {
	if m != nil {
		return m.SourceVerified
	}
	return false
}
...
var fileDescriptor_8858b63f7ddfb8d9 = []byte{
	...
	,
}
...
func (this *CodeMetadataPB) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.JsonSchema, that1.JsonSchema) {
		return false
	}
...
func (this *CodeInfoPB) Equal(that interface{}) bool {
	...
	if this.SourceVerified != that1.SourceVerified {
		return false
	}
	return true
}
...
func (m *CodeInfoPB) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Source) > 0 {
		...
		i = encodeVarintContract(dAtA, i, uint64(len(m.Source)))
		i--
		dAtA[i] = 0x52
	}
...
func (m *CodeMetadataPB) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.JsonSchema = append(m.JsonSchema[:0], dAtA[iNdEx:postIndex]...)
			if m.JsonSchema == nil {
				m.JsonSchema = []byte{}
			}
			iNdEx = postIndex
...
func (m *CodeInfoPB) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SourceVerified", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
