...
type GovMsg struct {
	...
	// https://github.com/cosmos/cosmos-sdk/blob/v0.42.5/proto/cosmos/gov/v1beta1/tx.proto#L24-L39
	SubmitProposal *SubmitProposalMsg `json:"submit_proposal,omitempty"`
	// https://github.com/cosmos/cosmos-sdk/blob/v0.42.5/proto/cosmos/gov/v1beta1/tx.proto#L61-L72
