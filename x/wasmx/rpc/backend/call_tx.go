...
func (b *Backend) DoCall(
	...
	funds := sdk.Coins{}
	if args.Value != nil {
		funds = sdk.NewCoins(sdk.NewCoin(app.BondBaseDenom, sdkmath.NewIntFromBigInt((*big.Int)(args.Value))))
	}
...
func (b *Backend) SendRawTransaction(data hexutil.Bytes) (common.Hash, error) {
	...
	cosmosTx, err := ethereumTx.BuildTx(b.clientCtx.TxConfig.NewTxBuilder(), app.BondBaseDenom)
	if err != nil {
