...
require (
	...
	github.com/cosmos/rosetta v0.0.0-20230926133138-b7599826d2fc // indirect
...
replace (
	...
	github.com/cosmos/ibc-go/v8 => github.com/cosmos/ibc-go/v8 v8.0.0-beta.0.0.20230929201115-89912e71368c
