...
func BuildWasmxImapVM_i64(ctx_ *vmtypes.Context, rnh memc.RuntimeHandler) (interface{}, error) {
	...
	fndefs := []memc.IFn{
		...
		vm.BuildFn("UIDSearch", UIDSearch, []interface{}{vm.ValType_I64()}, []interface{}{vm.ValType_I64()}, 0),
