...
const HOST_WASMX_ENV_SQL_i32_VER1 = "wasmx_postgresql_i32_1"
const HOST_WASMX_ENV_SQL_i64_VER1 = "wasmx_postgresql_i64_1"

const HOST_WASMX_ENV_SQL_EXPORT = "wasmx_postgresql_"

const HOST_WASMX_ENV_SQL = "postgresql"

type ContextKey string

const SqlContextKey ContextKey = "postgresql-context"
...
type SqlOpenConnection struct {
	Connection      string
	Db              *dbm.PostgreSQLDb
	OpenSavepointTx dbm.PostgreSqlBatch
...
func (p *SqlContext) SetConnection(id string, connection string, db *dbm.PostgreSQLDb, closed chan struct{}) error {
	p.mtx.Lock()
	defer p.mtx.Unlock()
