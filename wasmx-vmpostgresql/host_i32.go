...
func BuildWasmxSqlVM_i32(ctx_ *vmtypes.Context, rnh memc.RuntimeHandler) (interface{}, error) {
	...
	fndefs := []memc.IFn{
		...
		vm.BuildFn("CreateDatabase", CreateDatabase, []interface{}{vm.ValType_I32()}, []interface{}{vm.ValType_I32()}, 0),
		// TODO
