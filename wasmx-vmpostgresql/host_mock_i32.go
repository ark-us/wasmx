...
func BuildWasmxSqlVMMock_i32(ctx_ *vmtypes.Context, rnh memc.RuntimeHandler) (interface{}, error) {
	...
	fndefs := []memc.IFn{
		...
		vm.BuildFn("CreateDatabase", CreateDatabaseMock, []interface{}{vm.ValType_I32()}, []interface{}{vm.ValType_I32()}, 0),
	}

	return vm.BuildModule(rnh, "postgresql", context, fndefs)
}
